    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_fr",
                    models.CharField(max_length=100, verbose_name="Nom en francais"),
                ),
                (
                    "name_en",
                    models.CharField(max_length=100, verbose_name="Nom en anglais"),
                ),
                (
                    "cti_region",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        max_length=10, unique=True, verbose_name="Code departement"
                    ),
                ),
